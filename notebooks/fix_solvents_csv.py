...
strings_lst = (
    solvents_df[["solvent_name_1", "solvent_name_2", "solvent_name_3", "canon_smiles"]]
    .values.flatten()
    .tolist()
)
...
# %%
cas_names_dict_2 = {
    key: value[0] if value else "" for key, value in cas_names_dict.items()
}
