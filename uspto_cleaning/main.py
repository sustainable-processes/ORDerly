...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_with_label_called_other", type=int, default=3
    )  # save the reaction: label the rare molecule with 'other' rather than removing it
    ...
    assert (
        min_frequency_of_occurance_primary > save_with_label_called_other
        and min_frequency_of_occurance_secondary > save_with_label_called_other
    ...
    instance = uspto_cleaning.USPTO_cleaning.USPTO_cleaning(
