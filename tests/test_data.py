...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            [1234,12312,523423], ["1234","12312","523423"],
        ...
        pytest.param(
            ["abd", "asdsad", "sads"], ["abd", "asdsad", "sads"],
            id="standard str list"
        ),
        pytest.param(
            [123.23, 65, "sads"], ["123.23", "65", "sads"],
        ...
        pytest.param(
            [123.23, 65, "sads"], ["123.23", "65"],
            id="failing standard mixed list",
            marks=pytest.mark.xfail(
                reason="AssertionError: lists are different"
            ),
        ),
    )
)
def test_read_write_list_as_csv(tmp_path: pathlib.Path, input_list: List[Any], target_list: List[str]) -> None:
